...
public class Resources {
     ...
     * @return
     */
    public static ResourceBundle utf8Bundle(String name) {

        final ResourceBundle.Control control = new ResourceBundle.Control() {

            /**
             * This bundle cache duration is 30 [minutes]
             * 
             * @param baseName
             * @param locale
             * @return
            ...
            public long getTimeToLive(String baseName, Locale locale) {
                return 30 * 60000; // 1800 second （30minutes）
            }
